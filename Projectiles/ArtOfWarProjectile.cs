...
{
    public class ArtOfWarProjectile : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Art of War Projectile");     //The English name of the projectile
		...
		public override void SetDefaults()
		{
			...
			aiType = ProjectileID.PineNeedleFriendly;           //Act exactly like default Bullet
		}
